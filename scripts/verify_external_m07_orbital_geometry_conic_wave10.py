...
def self_test()->dict[str,Any]:
    ...
    if EXPECTED_CUMULATIVE_PROCESSED!=703:errors.append('EXPECTED_CUMULATIVE_PROCESSED mismatch')
    if EXPECTED_REMAINING_BACKLOG!=620:errors.append('EXPECTED_REMAINING_BACKLOG mismatch')
