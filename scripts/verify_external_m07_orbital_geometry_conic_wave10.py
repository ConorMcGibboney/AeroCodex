...
EXPECTED_CUMULATIVE_PROCESSED=578
EXPECTED_REMAINING_BACKLOG=745
...
def self_test()->dict[str,Any]:
    ...
    if EXPECTED_CUMULATIVE_PROCESSED!=578:errors.append('EXPECTED_CUMULATIVE_PROCESSED mismatch')
    if EXPECTED_REMAINING_BACKLOG!=745:errors.append('EXPECTED_REMAINING_BACKLOG mismatch')
