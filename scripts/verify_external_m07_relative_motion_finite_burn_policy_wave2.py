...
EXPECTED_CUMULATIVE_PROCESSED=1032
EXPECTED_REMAINING_BACKLOG=291
...
def self_test():
    ...
    require(EXPECTED_CUMULATIVE_PROCESSED==1032,'processed counter mismatch')
    require(EXPECTED_REMAINING_BACKLOG==291,'backlog counter mismatch')
