#!/usr/bin/env python3
"""Verify A32 external M07 relative-motion / finite-burn scalar policy Wave 2 terminal dispositions."""
...
RESOLUTION_PATH='formula-vault/resolutions/m07_relative_motion_finite_burn_policy_wave2.tsv'
INVENTORY_PATH='validation/equation_inventory.tsv'
SOURCE_ARTIFACT_ID='stage4.m07_rust_port_v14.2026_06_15'
SELECTED_LOCATORS=[
  "PORT_STATUS_RELEASE_GATE.csv:row_0972",
  "PORT_STATUS_RELEASE_GATE.csv:row_0976",
  "PORT_STATUS_RELEASE_GATE.csv:row_0977",
  "PORT_STATUS_RELEASE_GATE.csv:row_0978",
  "PORT_STATUS_RELEASE_GATE.csv:row_0979",
  "PORT_STATUS_RELEASE_GATE.csv:row_0980",
  "PORT_STATUS_RELEASE_GATE.csv:row_0981",
  "PORT_STATUS_RELEASE_GATE.csv:row_0982",
  "PORT_STATUS_RELEASE_GATE.csv:row_0983",
  "PORT_STATUS_RELEASE_GATE.csv:row_0986",
  "PORT_STATUS_RELEASE_GATE.csv:row_1235",
  "PORT_STATUS_RELEASE_GATE.csv:row_1236",
  "PORT_STATUS_RELEASE_GATE.csv:row_1237",
  "PORT_STATUS_RELEASE_GATE.csv:row_1238",
  "PORT_STATUS_RELEASE_GATE.csv:row_1240",
  "PORT_STATUS_RELEASE_GATE.csv:row_1241",
  "PORT_STATUS_RELEASE_GATE.csv:row_1245",
  "PORT_STATUS_RELEASE_GATE.csv:row_1246",
  "PORT_STATUS_RELEASE_GATE.csv:row_1247",
  "PORT_STATUS_RELEASE_GATE.csv:row_1248",
  "PORT_STATUS_RELEASE_GATE.csv:row_1249",
  "PORT_STATUS_RELEASE_GATE.csv:row_1250",
  "PORT_STATUS_RELEASE_GATE.csv:row_1252",
  "PORT_STATUS_RELEASE_GATE.csv:row_1253",
  "PORT_STATUS_RELEASE_GATE.csv:row_1254",
  "PORT_STATUS_RELEASE_GATE.csv:row_1255",
  "PORT_STATUS_RELEASE_GATE.csv:row_1256",
  "PORT_STATUS_RELEASE_GATE.csv:row_1257",
  "PORT_STATUS_RELEASE_GATE.csv:row_1258",
  "PORT_STATUS_RELEASE_GATE.csv:row_1260",
  "PORT_STATUS_RELEASE_GATE.csv:row_1261",
  "PORT_STATUS_RELEASE_GATE.csv:row_1262",
  "PORT_STATUS_RELEASE_GATE.csv:row_1263",
  "PORT_STATUS_RELEASE_GATE.csv:row_1264",
  "PORT_STATUS_RELEASE_GATE.csv:row_1265",
  "PORT_STATUS_RELEASE_GATE.csv:row_1266",
  "PORT_STATUS_RELEASE_GATE.csv:row_1267",
  "PORT_STATUS_RELEASE_GATE.csv:row_1268",
  "PORT_STATUS_RELEASE_GATE.csv:row_1269",
  "PORT_STATUS_RELEASE_GATE.csv:row_1270"
]
CANDIDATE_GROUPS=[
...
FUTURE_SAME_POOL_RESOLUTION_PATHS={'formula-vault/resolutions/m07_relative_motion_finite_burn_policy_wave3.tsv'}
EXPECTED_CANDIDATE_POOL_ROWS=69
EXPECTED_ROWS=40
EXPECTED_REMAINING_CANDIDATE_POOL_ROWS=29
EXPECTED_EXECUTABLE_ROWS=152
EXPECTED_METADATA_ROWS=28
EXPECTED_CUMULATIVE_PROCESSED=1080
EXPECTED_REMAINING_BACKLOG=243
EXPECTED_RISK_COUNTS=Counter({'blocked_until_frame_time_policy': 10, 'high_risk_requires_numerical_policy': 23, 'medium_risk_requires_contract_review': 7})
EXPECTED_FAMILY_COUNTS=Counter({'frame_graph_sensitive': 10, 'orbit_two_body': 15, 'iterative_solver': 8, 'low_risk_scalar_math': 7})
EXPECTED_SOURCE_GROUP_COUNTS=Counter({'9D_relative_motion_CW_LVLH_policy': 10, '9E_rocket_vehicle_policy_then_bounded_scalar_slice': 23, '9E_rocket_equation_scalar_subset_after_contract': 7})
EXPECTED_BLOCK_REASON_COUNTS=Counter({'blocked_until_relative_motion_frame_and_linearization_policy': 10, 'blocked_until_rocket_vehicle_model_and_solver_policy': 23, 'blocked_until_rocket_units_domain_and_sign_policy': 7})
BLOCK_TEXT={'blocked_until_relative_motion_frame_and_linearization_policy': 'Classifier row remains blocked until relative-motion frame definitions, local-vertical/local-horizontal conventions, linearization domain, reference-orbit assumptions, maneuver targeting contracts, and independent frame-aware validation oracles are explicitly approved; no runtime alias or implementation claim is made in A32.', 'blocked_until_rocket_vehicle_model_and_solver_policy': 'Classifier row remains blocked until rocket vehicle, finite-burn, staging, atmosphere, thrust, mass-flow, and numerical-propagation policies plus independent validation oracles are explicitly approved; no runtime alias or implementation claim is made in A32.', 'blocked_until_rocket_units_domain_and_sign_policy': 'Classifier row remains blocked until rocket-equation unit conventions, mass-ratio domain, delta-v sign policy, thrust-to-weight conventions, source registry, and independent scalar validation oracles are explicitly approved; no runtime alias or implementation claim is made in A32.'}
...
def main()->int:
    parser=argparse.ArgumentParser(description='Verify A32 external M07 relative-motion / finite-burn scalar policy Wave 2 metadata.')
