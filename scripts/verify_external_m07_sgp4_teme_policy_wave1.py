#!/usr/bin/env python3
"""Verify A40 external M07 SGP4 / TEME frame-time policy Wave 1 terminal dispositions."""
...
RESOLUTION_PATH='formula-vault/resolutions/m07_sgp4_teme_policy_wave1.tsv'
INVENTORY_PATH='validation/equation_inventory.tsv'
SOURCE_ARTIFACT_ID='stage4.m07_rust_port_v14.2026_06_15'
WAVE_ID='a40_external_m07_sgp4_teme_policy_wave1'
SELECTED_LOCATORS=['PORT_STATUS_RELEASE_GATE.csv:row_1305', 'PORT_STATUS_RELEASE_GATE.csv:row_1306', 'PORT_STATUS_RELEASE_GATE.csv:row_1307', 'PORT_STATUS_RELEASE_GATE.csv:row_1308', 'PORT_STATUS_RELEASE_GATE.csv:row_1309', 'PORT_STATUS_RELEASE_GATE.csv:row_1311', 'PORT_STATUS_RELEASE_GATE.csv:row_1312', 'PORT_STATUS_RELEASE_GATE.csv:row_1313', 'PORT_STATUS_RELEASE_GATE.csv:row_1314', 'PORT_STATUS_RELEASE_GATE.csv:row_1315', 'PORT_STATUS_RELEASE_GATE.csv:row_1316', 'PORT_STATUS_RELEASE_GATE.csv:row_1317', 'PORT_STATUS_RELEASE_GATE.csv:row_1318', 'PORT_STATUS_RELEASE_GATE.csv:row_1320', 'PORT_STATUS_RELEASE_GATE.csv:row_1321', 'PORT_STATUS_RELEASE_GATE.csv:row_1322', 'PORT_STATUS_RELEASE_GATE.csv:row_1323', 'PORT_STATUS_RELEASE_GATE.csv:row_1324', 'PORT_STATUS_RELEASE_GATE.csv:row_1325', 'PORT_STATUS_RELEASE_GATE.csv:row_1326', 'PORT_STATUS_RELEASE_GATE.csv:row_1327', 'PORT_STATUS_RELEASE_GATE.csv:row_1328', 'PORT_STATUS_RELEASE_GATE.csv:row_1329', 'PORT_STATUS_RELEASE_GATE.csv:row_1330', 'PORT_STATUS_RELEASE_GATE.csv:row_1331', 'PORT_STATUS_RELEASE_GATE.csv:row_1332', 'PORT_STATUS_RELEASE_GATE.csv:row_1333', 'PORT_STATUS_RELEASE_GATE.csv:row_1334', 'PORT_STATUS_RELEASE_GATE.csv:row_1335', 'PORT_STATUS_RELEASE_GATE.csv:row_1336', 'PORT_STATUS_RELEASE_GATE.csv:row_1337', 'PORT_STATUS_RELEASE_GATE.csv:row_1338', 'PORT_STATUS_RELEASE_GATE.csv:row_1339', 'PORT_STATUS_RELEASE_GATE.csv:row_1340', 'PORT_STATUS_RELEASE_GATE.csv:row_1341', 'PORT_STATUS_RELEASE_GATE.csv:row_1342', 'PORT_STATUS_RELEASE_GATE.csv:row_1343', 'PORT_STATUS_RELEASE_GATE.csv:row_1344', 'PORT_STATUS_RELEASE_GATE.csv:row_1345', 'PORT_STATUS_RELEASE_GATE.csv:row_1346', 'PORT_STATUS_RELEASE_GATE.csv:row_1347', 'PORT_STATUS_RELEASE_GATE.csv:row_1348', 'PORT_STATUS_RELEASE_GATE.csv:row_1349', 'PORT_STATUS_RELEASE_GATE.csv:row_1350', 'PORT_STATUS_RELEASE_GATE.csv:row_1351']
CANDIDATE_GROUPS={'10C_sgp4_teme_oracle_and_frame_time_gate', '10C_sgp4_hold_no_public_helper_import'}
...
EXPECTED_RISK_COUNTS=Counter({'blocked_until_frame_time_policy': 39, 'do_not_import': 6})
EXPECTED_FAMILY_COUNTS=Counter({'ambiguous_source_or_contract': 6, 'sgp4_teme_sensitive': 39})
EXPECTED_SOURCE_GROUP_COUNTS=Counter({'10C_sgp4_hold_no_public_helper_import': 6, '10C_sgp4_teme_oracle_and_frame_time_gate': 39})
EXPECTED_BLOCK_REASON_COUNTS=Counter({'blocked_until_sgp4_teme_frame_time_oracle_policy': 39, 'excluded_internal_sgp4_helper_not_public_formula': 6})
...
def verify_repo(repo):
    ...
    for row in resolution_rows:
        require(row['schema_version']==SCHEMA_VERSION,'schema mismatch'); require(row['source_artifact_id']==SOURCE_ARTIFACT_ID,'source artifact mismatch'); require(row['classifier_path']==CLASSIFIER_PATH,'classifier path mismatch'); require(row['validation_status']=='research_required','validation status mismatch'); require(row['target_formula_id']=='' and row['target_runtime_symbol']=='','runtime target must be empty'); require(row['disposition'] in EXPECTED_BLOCK_REASON_COUNTS,'disposition mismatch'); require('A40' in row['block_reason'],'block reason must identify A40')
...
def main(argv=None):
    ...
    try:
        ...
        payload={'schema_version':'aerocodex.external_m07.sgp4_teme_policy_wave1.error.v1','result':'FAIL','error':str(exc),**validation_contract_fields([str(exc)])}
