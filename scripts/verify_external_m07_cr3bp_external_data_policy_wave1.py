#!/usr/bin/env python3
"""Verify A41 external M07 CR3BP / external-data / input-output policy Wave 1 terminal dispositions."""
...
RESOLUTION_PATH='formula-vault/resolutions/m07_cr3bp_external_data_policy_wave1.tsv'
INVENTORY_PATH='validation/equation_inventory.tsv'
SOURCE_ARTIFACT_ID='stage4.m07_rust_port_v14.2026_06_15'
WAVE_ID='a41_external_m07_cr3bp_external_data_policy_wave1'
SELECTED_LOCATORS=['PORT_STATUS_RELEASE_GATE.csv:row_0502', 'PORT_STATUS_RELEASE_GATE.csv:row_0503', 'PORT_STATUS_RELEASE_GATE.csv:row_0504', 'PORT_STATUS_RELEASE_GATE.csv:row_0505', 'PORT_STATUS_RELEASE_GATE.csv:row_0519', 'PORT_STATUS_RELEASE_GATE.csv:row_0543', 'PORT_STATUS_RELEASE_GATE.csv:row_0572', 'PORT_STATUS_RELEASE_GATE.csv:row_0573', 'PORT_STATUS_RELEASE_GATE.csv:row_0595', 'PORT_STATUS_RELEASE_GATE.csv:row_0717', 'PORT_STATUS_RELEASE_GATE.csv:row_0761', 'PORT_STATUS_RELEASE_GATE.csv:row_0762', 'PORT_STATUS_RELEASE_GATE.csv:row_0763', 'PORT_STATUS_RELEASE_GATE.csv:row_0769', 'PORT_STATUS_RELEASE_GATE.csv:row_0776', 'PORT_STATUS_RELEASE_GATE.csv:row_0900', 'PORT_STATUS_RELEASE_GATE.csv:row_0901', 'PORT_STATUS_RELEASE_GATE.csv:row_0902', 'PORT_STATUS_RELEASE_GATE.csv:row_0903', 'PORT_STATUS_RELEASE_GATE.csv:row_0904', 'PORT_STATUS_RELEASE_GATE.csv:row_0907', 'PORT_STATUS_RELEASE_GATE.csv:row_0908', 'PORT_STATUS_RELEASE_GATE.csv:row_0911', 'PORT_STATUS_RELEASE_GATE.csv:row_0912', 'PORT_STATUS_RELEASE_GATE.csv:row_0913', 'PORT_STATUS_RELEASE_GATE.csv:row_0914', 'PORT_STATUS_RELEASE_GATE.csv:row_0915', 'PORT_STATUS_RELEASE_GATE.csv:row_0916', 'PORT_STATUS_RELEASE_GATE.csv:row_0917', 'PORT_STATUS_RELEASE_GATE.csv:row_0918', 'PORT_STATUS_RELEASE_GATE.csv:row_0919', 'PORT_STATUS_RELEASE_GATE.csv:row_0920', 'PORT_STATUS_RELEASE_GATE.csv:row_0923', 'PORT_STATUS_RELEASE_GATE.csv:row_0925', 'PORT_STATUS_RELEASE_GATE.csv:row_0926', 'PORT_STATUS_RELEASE_GATE.csv:row_0930', 'PORT_STATUS_RELEASE_GATE.csv:row_0931', 'PORT_STATUS_RELEASE_GATE.csv:row_0932', 'PORT_STATUS_RELEASE_GATE.csv:row_1182', 'PORT_STATUS_RELEASE_GATE.csv:row_1187', 'PORT_STATUS_RELEASE_GATE.csv:row_1188', 'PORT_STATUS_RELEASE_GATE.csv:row_1191', 'PORT_STATUS_RELEASE_GATE.csv:row_1203', 'PORT_STATUS_RELEASE_GATE.csv:row_1310', 'PORT_STATUS_RELEASE_GATE.csv:row_1319']
CANDIDATE_GROUPS={'10E_CR3BP_family_policy_and_oracle_before_promotion', '10D_external_data_table_and_fixture_governance', '10D_do_not_import_io_demo_utility_rows'}
...
EXPECTED_CUMULATIVE_PROCESSED=1170
EXPECTED_REMAINING_BACKLOG=153
EXPECTED_RISK_COUNTS=Counter({'blocked_until_source_review': 15, 'do_not_import': 7, 'high_risk_requires_numerical_policy': 23})
EXPECTED_FAMILY_COUNTS=Counter({'external_data_required': 15, 'ambiguous_source_or_contract': 7, 'blocked_until_policy': 20, 'coordinate_transform_sensitive': 2, 'iterative_solver': 1})
EXPECTED_SOURCE_GROUP_COUNTS=Counter({'10D_external_data_table_and_fixture_governance': 15, '10D_do_not_import_io_demo_utility_rows': 7, '10E_CR3BP_family_policy_and_oracle_before_promotion': 23})
EXPECTED_BLOCK_REASON_COUNTS=Counter({'blocked_until_external_data_fixture_registry_policy': 15, 'excluded_input_output_demo_or_reporting_row_not_public_formula': 7, 'blocked_until_cr3bp_family_taxonomy_oracle_policy': 23})
...
def verify_repo(repo):
    ...
    for row in resolution_rows:
        require(row['schema_version']==SCHEMA_VERSION,'schema mismatch'); require(row['source_artifact_id']==SOURCE_ARTIFACT_ID,'source artifact mismatch'); require(row['classifier_path']==CLASSIFIER_PATH,'classifier path mismatch'); require(row['validation_status']=='research_required','validation status mismatch'); require(row['target_formula_id']=='' and row['target_runtime_symbol']=='','runtime target must be empty'); require(row['disposition'] in EXPECTED_BLOCK_REASON_COUNTS,'disposition mismatch'); require('A41' in row['block_reason'],'block reason must identify A41')
...
def main(argv=None):
    ...
    try:
        ...
        payload={'schema_version':'aerocodex.external_m07.cr3bp_external_data_policy_wave1.error.v1','result':'FAIL','error':str(exc),**validation_contract_fields([str(exc)])}
