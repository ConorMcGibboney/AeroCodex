...
| `python scripts/verify_governance.py --repo .` | exits successfully | Formula-vault runtime resolutions and the configured xtask governance verifiers completed as a group. |
