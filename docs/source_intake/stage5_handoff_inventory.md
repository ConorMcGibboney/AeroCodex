...
| BioSim v3 B2a | Scenario-domain and deterministic structural-validation foundation | deployed/completed | needs_review | this bounded B2a deployment commit | No process flows, replay, adapter, ledger, report, example, full engine, controller, biological-fidelity, habitat-safety, medical, operational, parity, or certification claim. |
...
- Corrected BioSim B2a is deployed only as scenario-domain/structural-validation foundation; B2b-1, B2b-2, B2b-3, and B2c remain unstarted by B2a.
