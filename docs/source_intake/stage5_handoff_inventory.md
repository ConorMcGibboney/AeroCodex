...
- `completed`: deployed by a bounded Stage 5 session; no longer a pending intake candidate, but source-boundary and count-delta evidence remain required in the session closeout.
...
| `aerocodex_session_d_handoff.zip` | 27332 | `f8af7de84052a116286c257db4c0101815af306fc1e5d3f25324f059747fe140` | PASS | completed | deployed by bounded Stage 5 Session D as policy/templates/schema/inventory only; no other A-G material authorized |
