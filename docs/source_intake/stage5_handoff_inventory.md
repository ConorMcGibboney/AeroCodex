...
| D | `aerocodex_session_d_handoff.zip` | `f8af7de84052a116286c257db4c0101815af306fc1e5d3f25324f059747fe140` | 27332 | validation-card/source-seed generation policy and templates | `patch.patch` `47c9428114cb7a7c5f16349c23c77fc3d479f70f82cbc11bfcaa064152ba0af1` (21564 bytes) | patch.patch: PASS rc=0 | ready_for_live_intake | done | Deployed by bounded Stage 5 Session D; no other A-G material authorized. | No external source import; M07/BioSim/Orekit boundaries preserved. | Actual expected from live recursive template counting: validation_cards +1, source_registry_seeds +1, validation_card_only_records +1; executable/formula-vault/M07/helper counts +0. |
...
| `aerocodex_session_d_handoff.zip` | 27332 | `f8af7de84052a116286c257db4c0101815af306fc1e5d3f25324f059747fe140` | PASS | ready_for_live_intake | deployed by bounded Stage 5 Session D as policy/templates/schema/inventory only; no other A-G material authorized |
