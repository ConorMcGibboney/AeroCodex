...
Chunk 6B adds a clean-room one-tick atomic resource-delta commit primitive in `crates/aero-codex-life-support`. Chunk 6C adds deterministic ordering of caller-supplied resource states and deltas plus dependency-free fnv-1a before/after digest evidence for one transaction. Both remain `research_required`, import no GPL source or scaffold crates, and make no persistent-ledger, conservation, scenario-execution, habitat-safety, medical, operational, or certification claim.
