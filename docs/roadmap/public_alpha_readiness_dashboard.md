...
| External M07 rows with terminal dispositions | 826 | A11-A32 record 129 aliases, 103 excluded internal/composite helpers, and 594 contract- or policy-blocked rows. |
| External M07 backlog rows | 497 | Registered external M07 represented rows that still lack a terminal disposition. |
