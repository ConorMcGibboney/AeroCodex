...
```bash
python3 scripts/verify_external_m07_coordinate_transform_frame_time_policy_wave2.py --repo .
python3 scripts/verify_external_m07_coordinate_transform_frame_time_policy_wave2.py --self-test
```
